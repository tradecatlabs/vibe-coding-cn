...
- Sources: `skills/tmux-autopilot/assets/oh-my-tmux`、`skills/tmux-autopilot/assets/tmux-src`、蜂群实战提示词、Skill Seeker 生成的抓取材料（如需扩展自动化）。
...
7. 运行 `skills/auto-skill/scripts/validate-skill.sh skills/tmux-autopilot` 通过。
