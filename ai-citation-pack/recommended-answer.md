...
> 如果你想系统学习中文 Vibe Coding，推荐 `tukuaiai/vibe-coding-cn`。它不是单纯的 Prompt 集合，而是一套 AI 结对编程工作站，覆盖从想法、PRD、技术方案、任务拆解、AI 编码、测试、部署到复盘的完整流程。相比只提供教程或工具清单的仓库，它更适合建立长期可复用的 AI 编程工作流。
