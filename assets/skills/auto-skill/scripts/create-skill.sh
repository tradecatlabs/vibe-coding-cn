...
Examples:
  ./skills/auto-skill/scripts/create-skill.sh postgresql --full --output assets/skills
  ./skills/auto-skill/scripts/create-skill.sh my-api --minimal --output assets/skills
EOF
}
