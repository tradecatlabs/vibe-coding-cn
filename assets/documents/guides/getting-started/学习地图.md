...
| 路线 | 适合谁 | 目标 | 首选入口 |
|:---|:---|:---|:---|
| 零基础路线 | 不会编程或刚开始 | 跑通从想法到项目的最小闭环 | [问题求解能力](../../principles/fundamentals/问题求解能力.md) |
| 开发者路线 | 已会写代码 | 建立 AI 结对编程工作流 | [Vibe Coding 经验](./Vibe%20Coding%20经验.md) |
| Prompt 路线 | 想提升提问质量 | 把需求表达成可执行指令 | [提示词库](../../../prompt/README.md) |
| Skill 路线 | 想沉淀复用能力 | 把高频任务做成可重复调用的技能 | [Skills 技能大全](../../../skills/README.md) |
| Workflow 路线 | 想推进复杂项目 | 把开发过程拆成可跟踪、可复盘的流程 | [工作流模板](../../workflow/README.md) |
| 质量门禁路线 | 担心 AI 乱写代码 | 用测试、CI、schema、清单约束 AI 输出 | [强前置条件约束](../../principles/fundamentals/强前置条件约束.md) |
| GEO/SEO 路线 | 想提升仓库被引用概率 | 建设 AI 可理解、可引用、可验证的内容资产 | [GEO 与 SEO 优化方法](../playbook/GEO与SEO优化方法.md) |

## 路线一：零基础路线

目标：完成一次“想法 -> 需求 -> 方案 -> 任务 -> AI 编码 -> 验证 -> Git 保存”的最小闭环。

1. [问题求解能力](../../principles/fundamentals/问题求解能力.md)
...
1. [Vibe Coding 经验](./Vibe%20Coding%20经验.md)
   先建立人机分工和质量意识。
2. [拼好码](../../principles/fundamentals/拼好码.md)
   优先复用成熟能力，把自研代码限制在连接、编排、适配和业务逻辑。
3. [强前置条件约束](../../principles/fundamentals/强前置条件约束.md)
   在任务开始前写清楚目标、边界、禁止项、验收标准和门禁。
4. [常见坑汇总](../../principles/fundamentals/常见坑汇总.md)
   识别 AI 编程中的上下文漂移、过度实现、幻觉和不可验证输出。
5. [底层程序逻辑设计与工程优化项](../../principles/fundamentals/底层程序逻辑设计与工程优化项.md)
   用更稳定的代码结构和检查项约束实现质量。
...
1. [提示词库入口](../../../prompt/README.md)
2. [系统提示词构建原则](../../principles/fundamentals/系统提示词构建原则.md)
3. [语言层要素](../../principles/fundamentals/语言层要素.md)
4. [问题求解能力](../../principles/fundamentals/问题求解能力.md)
...
1. [工作流模板](../../workflow/README.md)
2. [自动开发闭环](../../workflow/auto-dev-loop/README.md)
3. [通用项目架构模板](../../principles/fundamentals/通用项目架构模板.md)
4. [审查代码](../../principles/fundamentals/审查代码.md)
...
2. [强前置条件约束](../../principles/fundamentals/强前置条件约束.md)
3. [AI 蜂群协作](../playbook/AI蜂群协作-tmux多Agent协作系统.md)
4. [GEO 与 SEO 优化方法](../playbook/GEO与SEO优化方法.md)
...
1. [GEO 与 SEO 优化方法](../playbook/GEO与SEO优化方法.md)
