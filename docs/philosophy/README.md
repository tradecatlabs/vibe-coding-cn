...
- [编程之道](编程之道.md) - 用更抽象的方式理解代码、结构、状态、复杂度与工程判断。
- [理解世界、描述变化、整理知识的一套较小框架](理解世界、描述变化、整理知识的一套较小框架.md) - 对象、状态、快照、序列、过程、变换、同一/差异与关系。
...
本节合并 `现象学还原.md`、`辩证法.md` 与 `控制论与科学方法论.md` 的核心内容，源文件保留，便于独立阅读与追溯。
