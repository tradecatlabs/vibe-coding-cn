...
| 开发者路线 | 已会写代码 | 建立 AI 结对编程工作流 | [Vibe Coding 经验](#2-vibe-coding-经验) |
...
5. [Vibe Coding 经验](#2-vibe-coding-经验)
...
1. [Vibe Coding 经验](#2-vibe-coding-经验)
   先建立人机分工和质量意识。
...
- 开发者：阅读 [Vibe Coding 经验](#2-vibe-coding-经验)，再选择 Skill 或质量门禁路线。
