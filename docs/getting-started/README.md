...
| [Vibe Coding 经验](#2-vibe-coding-经验) | 人机分工、门禁、复盘和 AI 审 AI |
...
- 开发者：阅读 [Vibe Coding 经验](README.md)，再选择 Skill 或质量门禁路线。
...
→ [CLI 配置](README.md) - 默认 AI CLI 路线，文末包含 OpenCode 备选方案
...
**前置条件**：请先完成 [网络环境配置](README.md)。推荐先完成 [CLI 配置](README.md)，让 Codex Agent 接管后续开发环境搭建。
