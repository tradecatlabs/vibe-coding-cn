...
<details>
<summary><strong>1. Vibe Coding 经验</strong> - 通用语言能力、人机分工、机器门禁和入门铁律。</summary>
...
<details>
<summary><strong>2. 学习地图</strong> - 新手、开发者、团队、Prompt、Skill、质量门禁和 GEO/SEO 的路线选择。</summary>
...
<details>
<summary><strong>3. 网络环境配置</strong> - OpenAI、GitHub、文档和依赖源访问。</summary>
...
<details>
<summary><strong>4. CLI 配置</strong> - Codex CLI 默认路线与 OpenCode 备选路线。</summary>
...
<details>
<summary><strong>5. 开发环境搭建</strong> - 让 Agent 主动配置开发依赖、编辑器建议和测试命令。</summary>
