...
| 企业级项目架构怎么搭 | [Enterprise Monorepo / Multi-Repo Reference Architecture Template](#reference-engineering-practice-enterprise-monorepo-multi-repo-reference-architecture-template) |
...
- [1. 工程实践](#reference-engineering-practice)
  ...
  - [1. 项目架构模板](#reference-engineering-practice-1-项目架构模板)
    ...
    - [Enterprise Monorepo / Multi-Repo Reference Architecture Template](#reference-engineering-practice-enterprise-monorepo-multi-repo-reference-architecture-template)
