...
| <a id="reference-modern-enterprise-architecture-kit"></a>[现代企业数字化平台 Starter Kit](modern-enterprise-architecture-kit/README.md) | 现代企业数字化平台 V2.1 的 schema、YAML 示例、嵌套约束和跨文件一致性校验入口。 |
...
- [现代企业数字化平台 Starter Kit](modern-enterprise-architecture-kit/README.md) - 现代企业数字化平台 V2.1 的 schema、YAML 示例、嵌套约束和跨文件一致性校验入口。
