...
`docs/research/` 的长期形态是“研究对象网络”，不是“外部链接清单”。每个持续研究对象都必须有自己的目录、raw 原始事实层、事实摘要层、判断层和维护边界。
...
| L1 | 理解 | `analysis.md` | 能解释架构、工作流、适用场景和风险 |
| L2 | 验证 | `deep-dive.md`、`experiments/` 或可复现验证记录 | 关键判断经过源码阅读、本地实验或一手资料核验 |
...
6. 更新 `docs/research/README.md`、`docs/README.md`、`metadata/taxonomy.yml` 和 AI 引用索引。
...
- `docs/research/README.md` 的索引判断中。
- 新增的独立对比文档中。
