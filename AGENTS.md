...
| `make check-modern-architecture-kit` | 校验现代企业数字化平台 starter kit 的 19 组 schema、示例和跨文件一致性 | Python 3 |
...
- `scripts/check-modern-architecture-kit.py` - 现代企业数字化平台 starter kit 的 19 组 schema、示例和跨文件一致性检查脚本，供 `make check-modern-architecture-kit` 与 CI 使用
...
- `docs/references/modern-enterprise-architecture-kit/README.md` - 现代企业数字化平台 V2.2 starter kit、schema、示例和一致性校验入口
